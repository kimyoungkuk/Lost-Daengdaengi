<template>
    <Page class="page">
        <ActionBar class="action-bar">
            <Label class="action-bar-title" text="사진을 찍어주세용"></Label>
        </ActionBar>
        <GridLayout rows=" *, auto, auto,auto,auto">
            ...
            <Button class="btn mybtn" row="3"  text="사진 찍기" @tap="onTakePictureTap" padding="10"/>
            <Button class="btn mybtn" row ="4" text = "만족합니다." :isEnabled="!processing" @tap="onSelect" padding="10"/>
        </GridLayout>
    </Page>
</template>
