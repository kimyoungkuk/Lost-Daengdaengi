<template>
    <div class="backgroundImage" v-bind:style="{ 'background-image': 'url(' + img1 + ')'}">
        ...
        <!-- 1. title-->
        <transition appear name="router-anim" mode="out-in" enter-active-class="animated fadeInLeft" leave-active-class="animated fadeOutRight">
...
export default {
    ...
    methods: {
        ...
        goReload() {
            this.$router.push("http://210.89.160.88")
        },
        toPrev(){
            this.page_num--;
            this.empty_check = 0;
